...
function ProfileLink({ theme } : {theme : any}) {
  ...
  return(
    ...
    className='flex gap-10
      ...
      <a className='flex items-center' download="Jaimin Godhani Resume" href={resume}  target='_blank'>
      ...
      link = "https://www.linkedin.com/in/jaimin-godhani-6b524b151/"
      />

      <ProfileLinkItem
      text='Github'
      icon={<TriangleRightFill strokeWidth={2} size={20}  className='ml-1'/>}
      link="https://github.com/Jai0401"
      />

      <a className='flex items-center' href='mailto: 21cs3025@rgipt.ac.in' target='_blank'>
