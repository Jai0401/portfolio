...
import resume from "../download/JaiminGodhani_CV.pdf"
            ...
            ">
                <Card i = {1} parentCard = {mainParent} expanded = {expanded} setExpanded={setExpanded} title="About Me">
                    <div className="
                        ...
                        <p className="
                        ">
                            A sophomore at Rajiv Gandhi Institute of Petroleum Technology, PA pursuing a degree Computer Science. <br />
                    ...
                    "
                    id="link_container">
                        <a href={resume} download="JaiminGodhani_CV.pdf" onClick={(e) => e.stopPropagation()}>
                            <Download strokeWidth={2} size={30} className="
                            h-6 2xl:h-fit
                            w-6 2xl:w-fit"/>
                        </a>

                        <a href="https://github.com/Jai0401" target="_blank" onClick={(e) => e.stopPropagation()}>
                        <GithubFill strokeWidth={2} size={30} className="
                        h-6 2xl:h-fit
                        w-6 2xl:w-fit"/>
                        </a>

                        <a href="https://www.linkedin.com/in/jaimin-godhani-6b524b151/" target="_blank" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="p-8">
                        <div className="leading-tight font-medium text-base">
                            ...
                            <div className="flex text-gray-950">
                                ...
                                <a className='w-fit' href="https://github.com/Jai0401/Aesthetique-Trend-Frontend" target="_blank" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="leading-tight font-medium text-base pt-5">
                            ...
                            <div className="flex">
                                ...
                                <a className='w-fit' href="https://github.com/Jai0401/synthboard-react" target="_blank" onClick={(e) => e.stopPropagation()}>
                                    <GithubFill strokeWidth={2} size={20} className="
                                    ml-2"/>
                                </a>
                            </div>
                        ...
                        <div className="leading-tight font-medium text-base pt-5 pb-3">
                            ...
                            <div className="flex">
                                ...
                                <a className='w-fit' href="https://github.com/Jai0401/OwlHack2023" target="_blank" onClick={(e) => e.stopPropagation()}>
                                    <GithubFill strokeWidth={2} size={20} className="
                                    ml-2"/>
                                </a>
                            </div>
