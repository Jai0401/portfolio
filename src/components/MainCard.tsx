...
import self_photo from "../images/self_photo.png"
        ...
        <>
            ...
            >
                ...
                ">
                    ...
                    ">
                        <h1 className='will-change-transform text-3xl lg:text-5xl 2xl:text-6xl'> Hello, I'm Jaimin Godhani.</h1>
                    </div>
