          ...
          <AnimatePresence>
            ...
            className="relative">
              ...
              id = "name_text_container">
                Hello, <br/>
                I'm
                <span style={{color: theme.main_color}}> Jaimin Godhani</span>
                .
              ...
              id = "links_container">
                ...
                id = "icon_container">
                  <a href="https://github.com/Jai0401" target="_blank">
                    <GithubFill size = {26}></GithubFill>
                  </a>

                  <a href={resume} download="JaiminGodhani_CV.pdf">
                    <File size = {26} strokeWidth = {2} ></File>
                  </a>

                  <a href="https://www.linkedin.com/in/jaimin-godhani-6b524b151/" target="_blank">
